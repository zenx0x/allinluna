...
The plugin must never transmit repository data, enable telemetry, widen sandbox permissions, perform destructive Git operations, or authorize external mutations without the user's explicit scope and the host's approval controls.
